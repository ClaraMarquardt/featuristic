...
# # version check (check against master file) (DEFAULT)
# #-------------------------------------------------#
# version 				  <- "V3_05_01_2017"
# # control_master_file 	  <- "/data/zolab/methods_new/base_code/feature_construction/execution_template/control.R"
# # variable_list_master_file <- "/data/zolab/methods_new/base_code/feature_construction/execution_template/variable_list.csv"
...
# # source(paste0(code_folder, "machine/control.R"))
...
# #--------------------------------#
# variable_list_file <- paste0(code_folder, "feature_construction/variable_list.csv")
...
# #----------------------------------------------------------------------------#
# assemble  <- TRUE       # assembl features?
# compile   <- TRUE      # compile assembled features? 
